...
def create_inventory(items):
    ...
    inventario = {}
    for item in items:
        indice=items.count(item)
        inventario[item] = indice
    return inventario
...
def find_max_value(diccionario):
    ...
    if diccionario == {}:
        ...
        for items in diccionario:
            if int(diccionario[items])>num:
                num=int(diccionario[items])
        for item in diccionario:
            if diccionario[item]==num:
                return item
