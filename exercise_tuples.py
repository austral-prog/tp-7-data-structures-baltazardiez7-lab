...
def convert_coordinate(coordenada):
    ...
    """
    coordenada1=coordenada[0:1]
    coordenada2=coordenada[1:2]
...
def create_record(registro_azara, registro_rui):
    ...
    """
    tesoro, coordenada_az = registro_azara
    ubicacion, coordenada_rui, cuadrante = registro_rui
    pte1, pte2 = coordenada_rui
    coordenada_rui1=f"{pte1}{pte2}"
    if coordenada_az == coordenada_rui1:
        return (tesoro, coordenada_az, ubicacion, coordenada_rui, cuadrante)
    else:
        return "not a match"
